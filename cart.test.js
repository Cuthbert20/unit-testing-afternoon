...
describe('Cart Method', () => {
    ...
    test(`addToCart() should add a car object to the cart array.`, () => {
        ...
        expect(cart.cart[0]).toEqual(car[0])
        expect(cart.cart[1]).toEqual(car[1])
    })
    ...
    test('removeFromCart() should remove a car obj from the cart array', () => {
        cart.addToCart( cars[0] );
        cart.addToCart( cars[1] );
        cart.addToCart( cars[2] );
